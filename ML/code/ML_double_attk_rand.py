...
if __name__ == "__main__":
    ...
    models.append(dataPath + "_bad_mixed_08_" + prop)
    models.append(dataPath + "_bad_mixed_12_" + prop)
    models.append(dataPath + "_bad_mixed_35_" + prop)
    models.append(dataPath + "_bad_mixed_49_" + prop)
    models.append(dataPath + "_bad_mixed_38_" + prop)
    pdb.set_trace()
    ...
    poisoning_compare.eval(Xtest, ytest, weights, 1, 7, numClasses, numFeatures)
    poisoning_compare.eval(Xtest, ytest, weights, 0, 8, numClasses, numFeatures)
    poisoning_compare.eval(Xtest, ytest, weights, 1, 2, numClasses, numFeatures)
    poisoning_compare.eval(Xtest, ytest, weights, 3, 5, numClasses, numFeatures)
    poisoning_compare.eval(Xtest, ytest, weights, 4, 9, numClasses, numFeatures)
    poisoning_compare.eval(Xtest, ytest, weights, 3, 8, numClasses, numFeatures)
